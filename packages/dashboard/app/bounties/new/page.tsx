...
export default function PostBountyPage() {
  ...
  const handlePublish = useCallback(async () => {
    ...
    try {
      ...
      // The unsigned tx is CBOR array [body, emptyWitnesses, isValid, auxData]
      // We need to replace the empty witnesses with the signed ones.
 ...
 */
function assembleSignedTx(unsignedTxHex: string, witnessSetHex: string): string {
